...
- Pull requests submitted against [**main**](https://github.com/gislevia/ProxmoxCommunityScripts/tree/main) are meticulously scrutinized, so please do not take it personally if the project maintainer rejects your request. By adhering to the established patterns and conventions throughout the codebase, you greatly increase the likelihood that your changes will get merged into [**main**](https://github.com/gislevia/ProxmoxCommunityScripts/tree/main).
