...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/gislevia/ProxmoxCommunityScripts/main/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
