...
# Use to copy all data from one Home Assistant LXC to another
# run from the Proxmox Shell
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/gislevia/ProxmoxCommunityScripts/main/misc/copy-data/home-assistant-container-copy-data-home-assistant-container.sh)"
