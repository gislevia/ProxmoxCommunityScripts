...
# Use to copy all data from a Home Assistant LXC to a Podman Home Assistant LXC
# run from the Proxmox Shell
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/gislevia/ProxmoxCommunityScripts/main/misc/copy-data/home-assistant-container-copy-data-podman-home-assistant.sh)"
