...
source /dev/stdin <<< $(wget -qLO - https://raw.githubusercontent.com/gislevia/ProxmoxCommunityScripts/main/misc/api.func)
...
More info at https://github.com/gislevia/ProxmoxCommunityScripts/discussions/272 \n"
